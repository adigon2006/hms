				...
				<div class="sidebar-container perfect-scrollbar">
					<nav>
						...
						<ul class="main-navigation-menu">
							...
							<li class="<?php if($page_name == 'manage_invoice')echo 'active open';?>">
								<a href="<?php echo base_url();?>index.php?accountant/manage_invoice">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"><?php echo get_phrase('invoice / take_payment');?></span>
										</div>
									</div>
								</a>
								
							</li>
                            			<li class="<?php if($page_name == 'view_payment')echo 'active open';?>">
								<a href="<?php echo base_url();?>index.php?accountant/view_payment">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"><?php echo get_phrase('view_payment');?></span>
										</div>
									</div>
								</a>
