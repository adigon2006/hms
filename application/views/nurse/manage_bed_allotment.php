<!-- start: DASHBOARD TITLE -->
							...
							<div class="row">
								...
								<div class="col-sm-5">
                                                 ...
                                                 echo  '<div class="notification" style="display:none;"><input type="text" placeholder="Enter a title ..." value="Notifications" class="form-control" id="title">
                                                       <textarea placeholder="Enter a message ..." rows="3" id="message" class="form-control">'.get_phrase('bed_allotment_created').'</textarea>
			...
			<div class="container-fluid container-fullw">
							<div class="row">
                            	...
                            	<?php echo form_open('nurse/manage_bed_allotment/edit/do_update/'.$row['bed_allotment_id'] , array('role' =>'form','id'=>'form'));?>
                                      ...
                                      <select name="bed_id" class="js-example-basic-single js-states form-control" style="width:100%;">
										...
										?>
                                        	<option value="<?php echo $row2['patient_id'];?>" <?php if($row2['patient_id'] == $row['patient_id'])echo 'selected';?>>
												<?php echo $row2['name'].' ('.$row2['client_number'].')';?>
                                            </option>
                                        <?php
										endforeach;
										?>
