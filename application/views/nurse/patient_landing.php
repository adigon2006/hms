						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
                                                            ...
                                                            <span class="mainDescription text-center"><?php echo get_phrase('search for patient name/Patient number if existing')?> </span>
                                                             <?php echo form_open('nurse/view_single_patient/view/' , array('role' =>'form','class'=>'form-inline'));?>  
										...
										?>
                                                            ...
                                                            <button type="submit" class="btn btn-primary form-control"><?php echo get_phrase('search for patient');?></button>
                                                             ...
                                                             <div class="form-group"><div class="col-md-6 col-lg-6"><a style="color:#ffffff;" href="<?php echo base_url();?>index.php?nurse/add_new_patient"><button type="submit" class="btn btn-primary form-control"><?php echo get_phrase('add_new_patient');?></button></a>
                                                             </div>
                                                                 <div class="col-md-6 col-lg-6"><a style="color:#ffffff;" href="<?php echo base_url();?>index.php?nurse/manage_patient"><button type="submit" class="btn btn-primary form-control"><?php echo get_phrase('view_all_patient');?></button></a>
                                                              </div>
                                                             </div>
                                                            </div>
							</div>
