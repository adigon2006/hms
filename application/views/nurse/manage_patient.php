...
<!-- start: DASHBOARD TITLE -->
							...
							<div class="row">
								<div class="col-md-12">
									...
									<i class="fa fa-bars"></i> <?php echo get_phrase('patient_list');?>
											...
											<li>
												<a href="<?php echo base_url();?>index.php?nurse/add_new_patient">
	...
	<?php echo form_open('nurse/manage_patient/edit/do_update/'.$row['patient_id'] , array('role' =>'form','id'=>'form'));?>
								...
								<div class="col-md-12">
									...
									<table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
										<thead>
											<tr>
												<th><div>#</div></th>
                    		<th><div><?php echo get_phrase('patient_name (Patient_Number)');?></div></th>
                    ...
                    <?php $count = 1;foreach($patients as $row):?>
						...
						<!-- end: DYNAMIC TABLE -->
							...
							<div class="row">
								<div class="col-md-6">
                                <div class="panel-body">
										<?php echo form_open('nurse/manage_patient/create/' , array('role' =>'form','id'=>'form'));?>
                                        <h4><?php echo get_phrase('personal_information');?></h4>
                                           <div class="form-group">
													<label class="control-label" >
														<?php echo get_phrase('Title');?> <span class="symbol required"></span>
		...
		<input type="text" name="nokphoneno" autocomplete="off" class="form-control underline"  placeholder="<?php echo get_phrase('phone_number');?>">
                                                ...
                                                <div class="form-group"> 
                                                <button type="submit" class="btn btn-primary"><?php echo get_phrase('add_patient');?></button>
                                                </div>
											<?php echo form_close();?> 
										</div>
                                </div>
