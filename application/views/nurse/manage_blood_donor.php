			...
			<div class="container-fluid container-fullw">
							<div class="row">
                                ...
                                <div class="panel-body">
										...
										<?php echo form_open('nurse/manage_blood_donor/edit/do_update/'.$row['blood_donor_id'] , array('role' =>'form'));?>
													...
													<input type="text" value="<?php echo $row['email'];?>" autocomplete="off" class="form-control underline"  placeholder="<?php echo get_phrase('email'); ?>" name="email" required="required">
												</div>
                                                                                         </div>
                                                                                               </div>
													...
													<input type="text" value="<?php echo $row['address'];?>" autocomplete="off" class="form-control underline"  placeholder="<?php echo get_phrase('address'); ?>" name="address " required="required">
												</div>
                                                                                                    </div>
													...
													<input type="text" value="<?php echo $row['age'];?>" autocomplete="off" class="form-control underline"  placeholder="<?php echo get_phrase('age'); ?>" name="age " required="required">
												</div>
										...
										<div class="row">
                                        <input type="text" value="<?php echo $row['last_donation_date'];?>" autocomplete="off" class="form-control underline format-datepicker"  placeholder="<?php echo get_phrase('date'); ?>" name="last_donation_date" required="required">
                                        </div>
								...
								<div class="col-md-12">
									...
									<table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
										<thead>
											<tr>
												<th><div>#</div></th>
												<th class="hidden-xs"><div><?php echo get_phrase('name');?></div></th>
												...
												<th class="hidden-xs"><div><?php echo get_phrase('options');?></div></th>
										...
										<tbody>
                                          <?php $count = 1;foreach($blood_donors as $row):?>
											<tr>
												...
												<td ><a href="<?php echo base_url();?>index.php?nurse/manage_blood_donor/edit/<?php echo $row['blood_donor_id'];?>"
						...
						<!-- end: DYNAMIC TABLE -->
							...
							<div class="row">
								<div class="col-md-12">
                                <div class="panel-body">
										<?php echo form_open('nurse/manage_blood_donor/create/' , array('role' =>'form','id'=>'form'));?>
                                    <div class="row">  <div class="col-md-6"><div class="form-group">
													<label class="control-label" for="exampleInputEmail1">
														<?php echo get_phrase('name');?> <span class="symbol required"></span>
													</label>
													...
													<input type="text" autocomplete="off" class="form-control underline"  placeholder="<?php echo get_phrase('email'); ?>" name="email" required="required">
												</div>
                                                                   </div>
													...
													<input type="text" autocomplete="off" class="form-control underline"  placeholder="<?php echo get_phrase('age'); ?>" name="age" required="required">
												</div> 
                                                                                                </div>
                                                                                                 </div>
                                        ...
                                        <input type="text" autocomplete="off" class="form-control underline format-datepicker"  placeholder="<?php echo get_phrase('date'); ?>" name="last_donation_date" required="required">
                                        </div>
