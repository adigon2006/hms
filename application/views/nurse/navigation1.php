...
<div class="primary-sidebar">
	...
	<ul class="nav nav-collapse collapse nav-collapse-primary">
		...
		<li class="dark-nav <?php if($page_name == 'manage_bed' || $page_name == 'manage_bed_allotment')echo 'active';?>">
          ...
          <!------assessment------>
		<li class="dark-nav <?php if($page_name == 'manage_risk_assessment' || $page_name == 'manage_vital_assessment')echo 'active';?>">
			<span class="glow"></span>
            <a class="accordion-toggle" data-toggle="collapse" href="#assess_submenu" >
                <i class="icon-hdd icon-2x"></i>
                <span><?php echo get_phrase('patient assessment');?><i class="icon-caret-down"></i></span>
            </a>
            
            <ul id="assess_submenu" class="collapse <?php if($page_name == 'manage_risk_assessment' || $page_name == 'manage_vital_assessment')echo 'in';?>">
                <li class="<?php if($page_name == 'manage_risk_assessment')echo 'active';?>">
                  <a href="<?php echo base_url();?>index.php?nurse/manage_risk_assessment">
                      <i class="icon-hdd"></i> <?php echo get_phrase('risk assessment');?>
                  </a>
                </li>
                <li class="<?php if($page_name == 'manage_vital_assessment')echo 'active';?>">
                  <a href="<?php echo base_url();?>index.php?nurse/manage_vital_assessment">
                      <i class="icon-wrench"></i> <?php echo get_phrase('vital assessment');?>
                  </a>
                </li>
            </ul>
		</li>
