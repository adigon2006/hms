							...
							<div id="inbox" class="inbox">
								...
								<div class="col email-options perfect-scrollbar">
									<div class="padding-15">
										<button class="btn btn-primary btn-block margin-bottom-30" data-toggle="modal" data-target=".bs-example-modal-lg">
											Compose
										</button>
...
<!--													<span class="messages-item-star" title="Mark as starred"><i class="fa fa-star"></i></span>
													...
													<div class="messages-item-time">
														<span class="text"><?php echo $email['timestamp'] ?></span>
													</div>
									...
									<div>
										<div class="message-actions">
											<ul class="actions no-margin no-padding block">
												...
												<li class="no-padding">
													<a href="?to=<?=$email['user_from_id'] ?>" class="text-info" id="reply">
														Reply
													</a>
												</li>
												...
												<li class="no-padding">
													<a href="?message=<?=$email['message_id'] ?>" id="delete">
														Delete
													</a>
												</li>
											</ul>
