			...
			<div class="container-fluid container-fullw">
							<div class="row">
                                ...
                                <div class="panel-body">
										...
										<?php echo form_open('nurse/manage_vital_assessment/edit/do_update/'.$row['vital_id'] , array('role' =>'form','id'=>'form'));?>
                         ...
                         <option value="<?php echo $row2['patient_id'];?>" <?php if($row2['patient_id'] == $row['patient_id'])echo 'selected';?>>
										...
										?>
												  ...
												  <div class="row">  <div class="col-md-6"> <div class="form-group">
													...
													<input type="text" value="<?php echo $row['temp'];?>" autocomplete="off" class="form-control underline"  placeholder="<?php echo get_phrase('temp');?>" name="temp" required="required" />
												</div>
                                                                                                           </div>
                                                                                                  </div>
                     ...
                     <th><div><?php echo get_phrase('temp(<sup>o</sup>C)');?></div></th>
                        ...
                        <tr>
							...
							<td align="center">
                            	<a href="<?php echo base_url();?>index.php?nurse/manage_vital_assessment/edit/<?php echo $row['vital_id'];?>"
                                	rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit');?>" class="btn btn-primary">
                                		<i class="fa fa-wrench"></i>
                                </a>
                            	<a href="<?php echo base_url();?>index.php?nurse/manage_vital_assessment/delete/<?php echo $row['vital_id'];?>" onclick="return confirm('delete?')"
						...
						<!-- end: DYNAMIC TABLE -->
							...
							<div class="row">
								<div class="col-md-12">
                                <div class="panel-body">
										<?php echo form_open('nurse/manage_vital_assessment/create/' , array('role' =>'form','id'=>'form'));?>
