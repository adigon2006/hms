...
<!--                    		<th><div><?php echo get_phrase('options');?></div></th>-->
                   	...
                   	<?php 
                        ...
                        <tr>
							...
							<td><?php echo $this->crud_model->get_type_name_by_id('patient',$row['patient_id'],'name').' ('.$this->crud_model->get_type_name_by_id('patient',$row['patient_id'],'name').')';?></td>
							<td><?php echo $this->crud_model->get_type_name_by_id('doctor',$row['doctor_id'],'name');?></td>
<!--							<td align="center">
                            	<a href="<?php echo base_url();?>index.php?pharmacist/manage_report/delete/<?php echo $row['report_id'];?>" onclick="return confirm('delete?')"
...
<!--							<td align="center">
						...
						<!-- end: DYNAMIC TABLE -->
							...
							<div class="row">
                                ...
                                <?php echo form_open('pharmacist/manage_report/create/' , array('role' =>'form','id'=>'form'));?>
