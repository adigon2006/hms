...
<!-- start: DASHBOARD TITLE -->
							...
							<div class="row">
								<div class="col-md-12">
									...
									<i class="fa fa-bars"></i> <?php echo get_phrase('patient_list');?>
											...
											<li>
												<a href="<?php echo base_url();?>index.php?doctor/add_new_patient" >
	...
	<?php echo form_open('doctor/manage_patient/edit/do_update/'.$row['patient_id'] , array('role' =>'form','id'=>'form'));?>
