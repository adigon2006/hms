								...
								<div class="col-sm-3">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle"><?php echo get_phrase('prescription');?></h2>
                                ...
                                <div class="col-sm-3">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle"><?php echo get_phrase('vitals');?></h2>
								...
								<div class="col-sm-3">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle"><?php echo get_phrase('report');?></h2>
                                ...
                                <div class="col-sm-3">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<p class="links cl-effect-1">
												<a href="<?php echo base_url();?>index.php?doctor/view_payment">
													view more
												</a>
											</p>
										</div>
