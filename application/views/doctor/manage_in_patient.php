<!-- start: DASHBOARD TITLE -->
						<section id="page-title" class="padding-top-15 padding-bottom-15">
							<div class="row">
								<div class="col-sm-7">
									<h1 class="mainTitle"><?php echo get_phrase('in_patient');?></h1>
									<span class="mainDescription"><?php echo get_phrase('manage_in_patient')?> </span>
								</div>
								<div class="col-sm-5">
                                                 ...
                                                 echo  '<div class="notification" style="display:none;"><input type="text" placeholder="Enter a title ..." value="Notifications" class="form-control" id="title">
                                                       <textarea placeholder="Enter a message ..." rows="3" id="message" class="form-control">'.get_phrase('New_patient_created').'</textarea>
								...
								<input type="text" value="3000" class="form-control input-small" placeholder="ms" id="extendedTimeOut">
                                                  ...
                                                  {
                                                    echo  '<div class="notification" style="display:none;"><input type="text" placeholder="Enter a title ..." value="Notifications" class="form-control" id="title">
                                                       <textarea placeholder="Enter a message ..." rows="3" id="message" class="form-control">'.get_phrase('New_patient_updated').'</textarea>
                                                               <div id="toastTypeGroup" class="form-group">
                                                                     <input type="radio" checked value="success" name="toasts" id="typesuccess"></div>
                                                                    <div id="positionGroup" class="form-group">
                                                                  <input type="radio" checked value="toast-top-full-width" name="positions" id="typetfw">
								...
								<input type="text" value="3000" class="form-control input-small" placeholder="ms" id="extendedTimeOut">
                                                  ...
                                                  {
                                                    echo  '<div class="notification" style="display:none;"><input type="text" placeholder="Enter a title ..." value="Notifications" class="form-control" id="title">
                                                       <textarea placeholder="Enter a message ..." rows="3" id="message" class="form-control">'.get_phrase('New_patient_deleted').'</textarea>
                                                               <div id="toastTypeGroup" class="form-group">
...
<!--											<li >
										...
										<i class="fa fa-wrench"></i> <?php echo get_phrase('edit_in_patient');?>
												</a>
											</li>-->
                                              <?php endif;?>
											<li class="active">
												<a href="#myTab1_example2" data-toggle="tab">
									<i class="fa fa-bars"></i> <?php echo get_phrase('in_patient_list');?>
												</a>
											</li>
<!--											<li>
												<a href="#myTab1_example3" data-toggle="tab">
											<i class="fa fa-plus"></i> <?php echo get_phrase('add_in_patient');?>
												</a>
											</li>-->
										</ul>
...
<!--					<div class="tab-pane fade in active" id="myTab1_example1"> 
			...
			<div class="container-fluid container-fullw">
							<div class="row">
                            	...
                            	<?php echo form_open('doctor/manage_in_patient/edit/do_update/'.$row['bed_allotment_id'] , array('role' =>'form','id'=>'form'));?>
                                    <div class="row"> <div class="col-md-6">		<div class="form-group">
                                      ...
                                      <select name="bed_id" class="js-example-basic-single js-states form-control" style="width:100%;">
										...
										?>
                                                ...
                                                <div class="form-group"> 
                                                <button type="submit" class="btn btn-primary"><?php echo get_phrase('edit_new_patient');?></button>
                                                </div>
											<?php echo form_close();?> 
...
<!--											<div class="tab-pane fade" id="myTab1_example3">
							...
							<div class="row">
								<div class="col-md-12">
                                <div class="panel-body">
										<?php echo form_open('doctor/manage_in_patient/create/' , array('role' =>'form','id'=>'form'));?>
										<div class="row"> <div class="col-md-6"><div class="form-group">
													<label class="control-label" for="exampleInputEmail1">
														<?php echo get_phrase('bed_number');?><span class="symbol required"></span>
													</label>
                                      <select name="bed_id" class="js-example-basic-single js-states form-control" style="width:100%;">
										...
										?>
                                                ...
                                                <div class="form-group"> 
                                                <button type="submit" class="btn btn-purple"><?php echo get_phrase('add_in_patient');?></button>
                                                </div>
											<?php echo form_close();?> 
										</div>
                                </div>
