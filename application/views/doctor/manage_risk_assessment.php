		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('doctor/manage_risk_assessment/edit/do_update/'.$row['risk_assessment_id'] , array('class' => 'form-horizontal validatable'));?>
                 <div class="padded">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center">
                            	<a href="<?php echo base_url();?>index.php?doctor/manage_risk_assessment/edit/<?php echo $row['risk_assessment_id'];?>"
                                	rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit');?>" class="btn btn-blue">
                                		<i class="icon-wrench"></i>
                                </a>
                            	<!--<a href="<?php echo base_url();?>index.php?doctor/manage_risk_assessment/delete/<?php echo $row['risk_assessment_id'];?>" onclick="return confirm('delete?')"
			...
			<!--<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('doctor/manage_risk_assessment/create/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                           <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('patient');?></label>
                                <div class="controls">
