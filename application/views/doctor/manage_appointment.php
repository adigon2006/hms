<!-- start: DASHBOARD TITLE -->
						<section id="page-title" class="padding-top-15 padding-bottom-15">
							<div class="row">
								<div class="col-sm-7">
									<h1 class="mainTitle"><?php echo get_phrase('manage_appointment');?></h1>
								...
								<div class="col-sm-5">
                                                 ...
                                                 echo  '<div class="notification" style="display:none;"><input type="text" placeholder="Enter a title ..." value="Notifications" class="form-control" id="title">
                                                       <textarea placeholder="Enter a message ..." rows="3" id="message" class="form-control">'.get_phrase('Appointment_created').'</textarea>
								...
								<input type="text" value="3000" class="form-control input-small" placeholder="ms" id="extendedTimeOut">
                                                  ...
                                                  {
                                                    echo  '<div class="notification" style="display:none;"><input type="text" placeholder="Enter a title ..." value="Notifications" class="form-control" id="title">
                                                       <textarea placeholder="Enter a message ..." rows="3" id="message" class="form-control">'.get_phrase('Appointment_updated').'</textarea>
                                                               <div id="toastTypeGroup" class="form-group">
                                                                     <input type="radio" checked value="success" name="toasts" id="typesuccess"></div>
                                                                    <div id="positionGroup" class="form-group">
                                                                  <input type="radio" checked value="toast-top-full-width" name="positions" id="typetfw">
								...
								<input type="text" value="3000" class="form-control input-small" placeholder="ms" id="extendedTimeOut">
                                                  ...
                                                  {
                                                    echo  '<div class="notification" style="display:none;"><input type="text" placeholder="Enter a title ..." value="Notifications" class="form-control" id="title">
                                                       <textarea placeholder="Enter a message ..." rows="3" id="message" class="form-control">'.get_phrase('Appointment_deleted').'</textarea>
                                                               <div id="toastTypeGroup" class="form-group">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="tabbable">
										...
										<i class="fa fa-wrench"></i> <?php echo get_phrase('edit_appointment');?>
												</a>
											</li>
                                              <?php endif;?>
											<li class="<?php if(!isset($edit_profile))echo 'active';?>">
												<a href="#myTab1_example2" data-toggle="tab">
									<i class="fa fa-bars"></i> <?php echo get_phrase('appointment_list');?>
												</a>
											</li>
											<li>
			...
			<div class="container-fluid container-fullw">
							<div class="row">
                                ...
                                <div class="panel-body">
										...
										<?php echo form_open('doctor/manage_appointment/edit/do_update/'.$row['appointment_id'] , array('role' =>'form','id'=>'form'));?>
									 <div class="row"><div class="col-md-6">		 <div class="form-group">
										...
										?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                    <div class="col-md-6">
													<input type="text" autocomplete="off" class="form-control underline format-datepicker"  placeholder="<?php echo get_phrase('date'); ?>" name="appointment_timestamp" value="<?php echo $row['appointment_timestamp'];?>" required="required">
												</div>
                                               <div class="col-md-6">
                                          <input type="text" id="" name="appointment_time" value="<?php echo $row['appointment_time'];?>"  class="timepicker-default form-control underline">
                                                ...
                                                <div class="form-group"> 
                                                <button type="submit" class="btn btn-primary"><?php echo get_phrase('edit_appointment');?></button>
                                                </div>
											<?php echo form_close();?>
                       ...
                       <a href="<?php echo base_url();?>index.php?doctor/manage_appointment/edit/<?php echo $row['appointment_id'];?>"
						...
						<!-- end: DYNAMIC TABLE -->
							...
							<div class="row">
								<div class="col-md-12">
                                <div class="panel-body">
										<?php echo form_open('doctor/manage_appointment/create/' , array('role' =>'form','id'=>'form'));?>
										 <div class="row"><div class="col-md-6">		<div class="form-group">
													<label class="control-label" for="exampleInputEmail1">
														<?php echo get_phrase('doctor');?> <span class="symbol required"></span>
													</label>
