								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle"><?php echo get_phrase('diagnosis_report');?></h2>
											<!--<p class="text-small">
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle"><?php echo get_phrase('manage_blood_bank');?></h2>
																						<p class="cl-effect-1">
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle"><?php echo get_phrase('manage_blood_donor');?></h2>
