								...
								<div class="col email-options perfect-scrollbar">
									<div class="padding-15">
										...
										<ul class="main-options padding-15">
											<li>
												<a href="<?php echo base_url();?>index.php?laboratorist/manage_email" id="loadinbox">
													<span class="title"><i class="ti-import"></i> Inbox</span>
													<span class="badge pull-right"><?php 
                                                                                                         $this->db->where(array('user_to_type'=>6,'user_to_id'=>$this->session->userdata('laboratorist_id'),'status'=>'2'));
                                                                                                       // $this->db->where(array('user_to_type'=>1,'user_to_id'=>"0"));
                                                                                                         echo $this->db->count_all_results('message');?></span>
												</a>
											</li>
											<li>
												<a href="<?php echo base_url();?>index.php?laboratorist/manage_email_sent/">
									...
									<div>
										<div class="message-actions">
											<ul class="actions no-margin no-padding block">
												...
												<li class="no-padding">
													<a href="<?php echo base_url();?>index.php?laboratorist/manage_email_sent/delete_email/<?=$typeofbox ?>/<?=$email['message_id'] ?>" id="delete" onclick="return confirm('Are you sure you want to delete this email')">
														Delete
													</a>
												</li>
											</ul>
											...
											<div class="modal-dialog modal-dialog modal-lg">
												<div class="modal-content">
													...
													<div class="modal-body">
                                                                                                            ...
                                                                                                            <input type="hidden" id="sender-group2" value="6" />
                                                                                                            <input type="hidden" id="sender-id2" value="<?php echo $this->session->userdata('laboratorist_id'); ?>" />
											...
											<div class="modal-dialog modal-dialog modal-lg">
												<div class="modal-content">
													...
													<div class="modal-body">
                                                                                                            ...
                                                                                                            <input type="hidden" id="sender-group3" value="6" />
                                                                                                            <input type="hidden" id="sender-id3" value="<?php echo $this->session->userdata('laboratorist_id'); ?>" />
                                                                                                                  <div class="form-group">  
                                                                                                                    <label class="control-label">Receiver</label>
											...
											<div class="modal-dialog modal-dialog modal-lg">
												<div class="modal-content">
													...
													<div class="modal-body">
                                                                                                            ...
                                                                                                            <input type="hidden" id="sender-group" value="6" />
                                                                                                            <input type="hidden" id="sender-id" value="<?php echo $this->session->userdata('laboratorist_id'); ?>" />
                                                                                                                  <div class="form-group">  
                                                                                                                    <label class="control-label">Receiver</label>
