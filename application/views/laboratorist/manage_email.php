...
<!--													<span class="messages-item-star" title="Mark as starred"><i class="fa fa-star"></i></span>
													...
													<div class="messages-item-time">
														<span class="text"><?php echo $email['timestamp'] ?>  
                                                                                                  <a href="<?php echo base_url();?>index.php?laboratorist/manage_email/delete_email/<?=$typeofbox ?>/<?=$email['message_id'] ?>"><i class="fa fa-trash pull-right"></i></a> <a href="?message=<?=$email['message_id'] ?>" class="forwardto"><i class="fa fa-arrow-right pull-right"></i></a> <a href="?to=<?=$email['message_id'] ?>" class="reply"><i class=" fa fa-reply pull-right"></i></a>
												</span>
													</div>
									...
									<div>
										<div class="message-actions">
											<ul class="actions no-margin no-padding block">
												...
												<li class="no-padding">
													<a href="<?php echo base_url();?>index.php?laboratorist/manage_email/delete_email/<?=$typeofbox ?>/<?=$email['message_id'] ?>" id="delete" onclick="return confirm('Are you sure you want to delete this email')">
														Delete
													</a>
												</li>
											</ul>
