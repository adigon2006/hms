<!-- start: DASHBOARD TITLE -->
						<section id="page-title" class="padding-top-15 padding-bottom-15">
							<div class="row">
								<div class="col-sm-7">
									<h1 class="mainTitle"><?php echo get_phrase('MANAGE_BLOOD_DONOR');?></h1>
								...
								<div class="col-sm-5">
									<!-- start: MINI STATS WITH SPARKLINE -->
                                                 ...
                                                 echo  '<div class="notification" style="display:none;"><input type="text" placeholder="Enter a title ..." value="Notifications" class="form-control" id="title">
                                                       <textarea placeholder="Enter a message ..." rows="3" id="message" class="form-control">'.get_phrase('Blood_donor_created').'</textarea>
								...
								<input type="text" value="3000" class="form-control input-small" placeholder="ms" id="extendedTimeOut">
                                                  ...
                                                  {
                                                    echo  '<div class="notification" style="display:none;"><input type="text" placeholder="Enter a title ..." value="Notifications" class="form-control" id="title">
                                                       <textarea placeholder="Enter a message ..." rows="3" id="message" class="form-control">'.get_phrase('Blood_donor_updated').'</textarea>
                                                               <div id="toastTypeGroup" class="form-group">
                                                                     <input type="radio" checked value="success" name="toasts" id="typesuccess"></div>
                                                                    <div id="positionGroup" class="form-group">
                                                                  <input type="radio" checked value="toast-top-full-width" name="positions" id="typetfw">
								...
								<input type="text" value="3000" class="form-control input-small" placeholder="ms" id="extendedTimeOut">
                                                  ...
                                                  {
                                                    echo  '<div class="notification" style="display:none;"><input type="text" placeholder="Enter a title ..." value="Notifications" class="form-control" id="title">
                                                       <textarea placeholder="Enter a message ..." rows="3" id="message" class="form-control">'.get_phrase('Blood_donor_deleted').'</textarea>
                                                               <div id="toastTypeGroup" class="form-group">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="tabbable">
										...
										<i class="fa fa-wrench"></i> <?php echo get_phrase('edit_blood_donor');?>
												</a>
											</li>
                                              <?php endif;?>
											<li class="<?php if(!isset($edit_profile))echo 'active';?>">
												<a href="#myTab1_example2" data-toggle="tab">
									<i class="fa fa-bars"></i> <?php echo get_phrase('blood_donor_list');?>
												</a>
											</li>
											<li>
			...
			<div class="container-fluid container-fullw">
							<div class="row">
                                ...
                                <div class="panel-body">
										...
										<?php echo form_open('laboratorist/manage_blood_donor/edit/do_update/'.$row['blood_donor_id'] , array('role' =>'form'));?>
					                             <div class="row">
                                                    <div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" autocomplete="off" class="form-control underline" value="<?php echo $row['name'];?>"  placeholder="<?php echo get_phrase('Enter_name'); ?>" name="name" required="required">
												</div>
                                                    </div>
                                                                                    <div class="col-md-6">
												<div class="form-group">
													...
													<input type="email" name="email" autocomplete="off" value="<?php echo $row['email'];?>" class="form-control underline" id="exampleInputPassword1" placeholder="<?php echo get_phrase('Enter_email');?>" required="required">
												</div>
                                                                                    </div>
                                                                                </div>
                                        <div class="row">
													...
													<input type="text" name="address" value="<?php echo $row['address'];?>" autocomplete="off" class="form-control underline" id="exampleInputPassword1" placeholder="<?php echo get_phrase('Enter_address');?>" required="required">
												</div>
                                                    </div>
                                            <div class="col-md-6">
                                                                                                <div class="form-group">
													...
													<input type="text" name="phone" value="<?php echo $row['phone'];?>" autocomplete="off" class="form-control underline" id="exampleInputPassword1" placeholder="<?php echo get_phrase('Enter_phone');?>" required="required">
												</div>
                                            </div>
                                        </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
													...
													<input type="text" name="age" value="<?php echo $row['age'];?>" autocomplete="off" class="form-control underline" id="exampleInputPassword1" placeholder="<?php echo get_phrase('Enter_age');?>" required="required">
												</div>
                                        </div>
                                    </div>
                                      <div class="row">
                                    ...
                                    <div class="form-group">
													<label for="exampleInputPassword1">
														<?php echo get_phrase('last_donation_date');?> <span class="symbol required"></span>
													</label>
                                    <input type="text" autocomplete="off" class="form-control underline format-datepicker"  placeholder="<?php echo get_phrase('last_donation_date'); ?>" value="<?php echo date('m/d/Y',$row['last_donation_timestamp']);?>" name="last_donation_timestamp" required="required">
                                    </div>    
                                          </div>
                                      </div> 
                                                <div class="form-group"> 
                                                <button type="submit" class="btn btn-primary"><?php echo get_phrase('edit_blood_donor');?></button>
                                                </div>
											<?php echo form_close();?> 
						...
						<!-- end: DYNAMIC TABLE -->
							...
							<div class="row">
								<div class="col-md-12">
                                <div class="panel-body">
										<?php echo form_open('laboratorist/manage_blood_donor/create/' , array('role' =>'form','id'=>'form'));?>
                                                                                <div class="row">
                                                    <div class="col-md-6">
												<div class="form-group">
													<label class="control-label" for="exampleInputEmail1">
													...
													<input type="text" autocomplete="off" class="form-control underline"  placeholder="<?php echo get_phrase('Enter_name'); ?>" name="name" required="required">
												</div>
                                                    </div>
                                                                                    <div class="col-md-6">
												<div class="form-group">
													...
													<input type="email" name="email" autocomplete="off" class="form-control underline" id="exampleInputPassword1" placeholder="<?php echo get_phrase('Enter_email');?>" required="required">
												</div>
                                                                                    </div>
                                                                                </div>
                                        <div class="row">
													...
													<input type="text" name="address" autocomplete="off" class="form-control underline" id="exampleInputPassword1" placeholder="<?php echo get_phrase('Enter_address');?>" required="required">
												</div>
                                                    </div>
                                            <div class="col-md-6">
                                                                                                <div class="form-group">
													...
													<input type="text" name="phone" autocomplete="off" class="form-control underline" id="exampleInputPassword1" placeholder="<?php echo get_phrase('Enter_phone');?>" required="required">
												</div>
                                            </div>
                                        </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
													...
													<input type="text" name="age" autocomplete="off" class="form-control underline" id="exampleInputPassword1" placeholder="<?php echo get_phrase('Enter_age');?>" required="required">
												</div>
                                        </div>
                                    </div>
                                      <div class="row">
                                    ...
                                    <input type="text" autocomplete="off" class="form-control underline format-datepicker"  placeholder="<?php echo get_phrase('last_donation_date'); ?>" name="last_donation_timestamp" required="required">
                                    </div>    
                                          </div>
                                      </div>
                                                <div class="form-group"> 
                                                <button type="submit" class="btn btn-primary"><?php echo get_phrase('add_blood_donor');?></button>
                                                </div>
											<?php echo form_close();?> 
										</div>
                                </div>
