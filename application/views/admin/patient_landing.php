						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
                                                            ...
                                                            <span class="mainDescription text-center"><?php echo get_phrase('search for patient name/patient Number if existing')?> </span>
                                                             <?php echo form_open('admin/view_patient_profile/view/' , array('role' =>'form','class'=>'form-inline'));?>  
                                                              
                                                                    <div class="form-group"> 
                                                                        
                                                                <select name="patient_id" class="js-example-basic-single js-states form-control" style="width:100%;">
                                                                <option value="">Search for patient by name/Patient Number</option>
                                                                <?php 
										...
										?>
                                                            ...
                                                            <button type="submit" class="btn btn-primary form-control"><?php echo get_phrase('search for patient');?></button>
                                                             ...
                                                             <div class="form-group"><div class="col-md-6 col-lg-6"><a style="color:#ffffff;" href="<?php echo base_url();?>index.php?admin/add_new_patient"><button type="submit" class="btn btn-primary form-control"><?php echo get_phrase('add_new_patient');?></button></a>
                                                             </div>
                                                                 <div class="col-md-6 col-lg-6"><a style="color:#ffffff;" href="<?php echo base_url();?>index.php?admin/manage_patient"><button type="submit" class="btn btn-primary form-control"><?php echo get_phrase('view_all_patient');?></button></a>
                                                              </div>
                                                             </div>
                                                            </div>
							</div>
