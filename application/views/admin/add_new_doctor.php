						...
						<section id="page-title" class="padding-top-15 padding-bottom-15">
							<div class="row">
								<div class="col-sm-7">
									...
									<span class="mainDescription"><?php echo get_phrase('add_new_doctor')?> </span>
								</div>
								<div class="col-sm-5">
						...
						<!-- end: DASHBOARD TITLE -->
								...
								<input type="text" value="3000" class="form-control input-small" placeholder="ms" id="extendedTimeOut">
														...
														<div class="row">
															<div class="col-md-6">
																...
																<div class="form-group">
																	...
																	<input type="text" placeholder="<?php echo get_phrase('name'); ?>" class="form-control" value="<?php echo $this->session->userdata('name'); ?>" id="lastname" name="name" required="required">
																</div>
																<div class="form-group">
																	<label class="control-label">
																		Email Address <span class="symbol required"></span>
																	</label>
																	<input type="email" placeholder="peter@example.com" class="form-control" value="<?php echo $this->session->userdata('email'); ?>" id="email" name="email" required="required">
																</div>
                                                                                                                            <div class="form-group">
																	<label class="control-label">
																	...
																	<input type="text"  placeholder="Phone" class="form-control" id="password_again" value="<?php echo $this->session->userdata('phone'); ?>" name="phone" required="required">
																</div>
																<div class="form-group">
																	<label class="control-label">
																		Address <span class="symbol required"></span>
																	</label>
																	<input type="text" placeholder="Address" class="form-control" value="<?php echo $this->session->userdata('address'); ?>" id="address" name="address" required="required">
																</div>
                                       ...
                                       <?php 
										...
										?>
                                    		<option <?php if($this->session->userdata('department_id') == $row['department_id']){echo 'selected';} ?> value="<?php echo $row['department_id'];?>"><?php echo $row['name'];?></option>
                                        <?php
										endforeach;
										?> 
													...
													<input type="text" name="profile" autocomplete="off" class="form-control "  value="<?php echo $this->session->userdata('profile'); ?>" placeholder="<?php echo get_phrase('profile');?>">
												</div>
																<div class="form-group">
																	<label>
																		Image Upload
													...
													<div class="row">
														<div class="col-md-8">
															<p>
																By clicking Add, you are creating a new user.
															</p>
														</div>
														<div class="col-md-4">
