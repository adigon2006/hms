<!-- start: DASHBOARD TITLE -->
						<section id="page-title" class="padding-top-15 padding-bottom-15">
							<div class="row">
								<div class="col-sm-7">
									<h1 class="mainTitle"><?php echo get_phrase('CUSTOMER_CARE');?></h1>
									<span class="mainDescription"><?php echo get_phrase('manage_customer_care');?> </span>
								</div>
								<div class="col-sm-5">
                                                 ...
                                                 echo  '<div class="notification" style="display:none;"><input type="text" placeholder="Enter a title ..." value="Notifications" class="form-control" id="title">
                                                       <textarea placeholder="Enter a message ..." rows="3" id="message" class="form-control">'.get_phrase('Customer_care_created').'</textarea>
								...
								<input type="text" value="3000" class="form-control input-small" placeholder="ms" id="extendedTimeOut">
                                                  ...
                                                  {
                                                    echo  '<div class="notification" style="display:none;"><input type="text" placeholder="Enter a title ..." value="Notifications" class="form-control" id="title">
                                                       <textarea placeholder="Enter a message ..." rows="3" id="message" class="form-control">'.get_phrase('Customer_care_updated').'</textarea>
                                                               <div id="toastTypeGroup" class="form-group">
                                                                     <input type="radio" checked value="success" name="toasts" id="typesuccess"></div>
                                                                    <div id="positionGroup" class="form-group">
                                                                  <input type="radio" checked value="toast-top-full-width" name="positions" id="typetfw">
								...
								<input type="text" value="3000" class="form-control input-small" placeholder="ms" id="extendedTimeOut">
                                                  ...
                                                  {
                                                    echo  '<div class="notification" style="display:none;"><input type="text" placeholder="Enter a title ..." value="Notifications" class="form-control" id="title">
                                                       <textarea placeholder="Enter a message ..." rows="3" id="message" class="form-control">'.get_phrase('Customer_care_deleted').'</textarea>
                                                               <div id="toastTypeGroup" class="form-group">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="tabbable">
										...
										<i class="fa fa-wrench"></i> <?php echo get_phrase('edit_customer_care');?>
												</a>
											</li>
                                              <?php endif;?>
											<li class="<?php if(!isset($edit_profile))echo 'active';?>">
												<a href="#myTab1_example2" data-toggle="tab">
									<i class="fa fa-bars"></i> <?php echo get_phrase('customer_care_list');?>
												</a>
											</li>
											<li>
												<a href="<?php echo base_url();?>index.php?admin/add_new_customercare" >
											<i class="fa fa-plus"></i> <?php echo get_phrase('add_customer_care');?>
												</a>
											</li>
										</ul>
            ...
            <div class="container-fluid container-fullw">
							<div class="row">
								...
								<?php echo form_open('admin/manage_customer_care/edit/do_update/'.$row['customercare_id'] , array('role' =>'form'));?>
					 ...
					 <div class="form-group">
													...
													<input type="text" name="skype" value="<?=$row['linkedin']?>" autocomplete="off" class="form-control underline"  placeholder="<?php echo get_phrase('Skype');?> ">
												</div>
						      
                                         </div>
                                     </div>
                                                <div class="form-group"> 
                                                <button type="submit" class="btn btn-primary"><?php echo get_phrase('edit_customer_care');?></button>
                                                </div>
											<?php echo form_close();?> 		
						...
						<div class="container-fluid container-fullw bg-white">
								...
								<div class="col-md-12">
									...
									<table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
										<thead>
											<tr>
											<th><div>#</div></th>
                    		<th><div><?php echo get_phrase('customer care rep name');?></div></th>
                    		...
                    		<th><div><?php echo get_phrase('options');?></div></th>
										...
										<tbody>
                     <?php $count = 1;foreach($customer_care as $row):?>
                        <tr>
							...
							<td align="center">
                            	<a href="<?php echo base_url();?>index.php?admin/manage_customer_care/edit/<?php echo $row['customercare_id'];?>"
                                	rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit');?>" class="btn btn-primary">
                                		<i class="fa fa-wrench"></i>
                                </a>
                            	<a href="<?php echo base_url();?>index.php?admin/manage_customer_care/delete/<?php echo $row['customercare_id'];?>" onclick="return confirm('delete?')"
						...
						<!-- end: DYNAMIC TABLE -->
							...
							<div class="row">
								<div class="col-md-6">
                                <div class="panel-body">
										<?php echo form_open('admin/manage_customer_care/create/' , array('role' =>'form','id'=>'form'));?>
												<div class="form-group">
													<label class="control-label" for="exampleInputEmail1">
														<?php echo get_phrase('name');?> <span class="symbol required"></span>
													</label>
                                                ...
                                                <div class="form-group"> 
                                                <button type="submit" class="btn btn-purple"><?php echo get_phrase('add_customer_care');?></button>
                                                </div>
											<?php echo form_close();?> 
										</div>
                                </div>
