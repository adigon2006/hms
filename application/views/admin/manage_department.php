<!-- start: DASHBOARD TITLE -->
						<section id="page-title" class="padding-top-15 padding-bottom-15">
							<div class="row">
								<div class="col-sm-7">
									<h1 class="mainTitle"><?php echo get_phrase('MANAGE_DEPARTMENT');?></h1>
            ...
            <div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-md-12">
									...
									<i class="fa fa-bars"></i> <?php echo get_phrase('department_list');?>
												</a>
											</li>
											<li>
								...
								<div class="col-md-12">
									...
									<table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
										<thead>
											<tr>
												<th><div>#</div></th>
												<th class="hidden-xs"><div><?php echo get_phrase('department_name');?></div></th>
										...
										<tbody>
                                          <?php $count = 1;foreach($departments as $row):?>
											<tr>
												...
												<td ><a href="<?php echo base_url();?>index.php?admin/manage_department/edit/<?php echo $row['department_id'];?>"
