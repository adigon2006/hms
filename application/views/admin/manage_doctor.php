<!-- start: DASHBOARD TITLE -->
						<section id="page-title" class="padding-top-15 padding-bottom-15">
							<div class="row">
								<div class="col-sm-7">
									<h1 class="mainTitle"><?php echo get_phrase('DOCTOR');?></h1>
									<span class="mainDescription"><?php echo get_phrase('manage_doctor');?> </span>
								</div>
								<div class="col-sm-5">
                                                 ...
                                                 echo  '<div class="notification" style="display:none;"><input type="text" placeholder="Enter a title ..." value="Notifications" class="form-control" id="title">
                                                       <textarea placeholder="Enter a message ..." rows="3" id="message" class="form-control">'.get_phrase('doctor_created').'</textarea>
								...
								<input type="text" value="3000" class="form-control input-small" placeholder="ms" id="extendedTimeOut">
                                                  ...
                                                  {
                                                    echo  '<div class="notification" style="display:none;"><input type="text" placeholder="Enter a title ..." value="Notifications" class="form-control" id="title">
                                                       <textarea placeholder="Enter a message ..." rows="3" id="message" class="form-control">'.get_phrase('doctor_updated').'</textarea>
                                                               <div id="toastTypeGroup" class="form-group">
                                                                     <input type="radio" checked value="success" name="toasts" id="typesuccess"></div>
                                                                    <div id="positionGroup" class="form-group">
                                                                  <input type="radio" checked value="toast-top-full-width" name="positions" id="typetfw">
								...
								<input type="text" value="3000" class="form-control input-small" placeholder="ms" id="extendedTimeOut">
                                                  ...
                                                  {
                                                    echo  '<div class="notification" style="display:none;"><input type="text" placeholder="Enter a title ..." value="Notifications" class="form-control" id="title">
                                                       <textarea placeholder="Enter a message ..." rows="3" id="message" class="form-control">'.get_phrase('doctor_deleted').'</textarea>
                                                               <div id="toastTypeGroup" class="form-group">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="tabbable">
										...
										<i class="fa fa-wrench"></i> <?php echo get_phrase('edit_doctor');?>
												</a>
											</li>
                                              <?php endif;?>
											<li class="<?php if(!isset($edit_profile))echo 'active';?>">
												<a href="#myTab1_example2" data-toggle="tab">
									<i class="fa fa-bars"></i> <?php echo get_phrase('doctor_list');?>
												</a>
											</li>
											<li>
												<a href="<?php echo base_url();?>index.php?admin/add_new_doctor">
            ...
            <div class="container-fluid container-fullw">
							<div class="row">
								...
								<?php echo form_open('admin/manage_doctor/edit/do_update/'.$row['doctor_id'] , array('role' =>'form'));?>
                                        ...
                                        <div class="row"> <div class="col-md-6">
                                                <div class="form-group">
													...
													<input type="text" autocomplete="off" class="form-control underline"  placeholder="<?php echo get_phrase('phone'); ?>" name="phone" required="required" value="<?php echo $row['phone']?>">
                                                       ...
                                                       <div class="form-group">
													<label class="control-label" >
														<?php echo get_phrase('department');?> <span class="symbol required"></span>
													</label>
										<select name="department_id" class="js-example-basic-single js-states form-control" style="width:100%;">
                                       <?php 
                                    ...
                                    <div class="row"> <div class="col-md-6">
                                     <div class="form-group">
										...
										<select name="sex" class="js-example-basic-single js-states form-control" style="width:100%;">
                                                                                    ...
                                                                                    <option value="Male" <?php if($row['sex'] == "Male"){echo "selected='selected'";}?>>
                                                                                        Male
                                                                                    </option>
                                                                                    <option value="Female" <?php if($row['sex'] == "Female"){echo "selected='selected'";}?>>
                                                                                        Female
                                                                                    </option>
                                        </select>
												</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row"> <div class="col-md-12">
											 <div class="form-group">
													...
													<input type="text" name="skype" value="<?=$row['skype']?>" autocomplete="off" class="form-control underline"  placeholder="<?php echo get_phrase('Skype ID');?> ">
												</div>
                                                <div class="form-group"> 
                                                <button type="submit" class="btn btn-primary"><?php echo get_phrase('edit_doctor');?></button>
                                                </div>
                                            </div>
                                        </div>
											<?php echo form_close();?> 		
								...
								<div class="col-md-12">
									...
									<table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
										<thead>
											<tr>
												<th><div>#</div></th>
												<th class="hidden-xs"><div><?php echo get_phrase('doctor_name');?></div></th>
                     ...
                     <?php $count = 1;foreach($doctors as $row):?>
											<tr>
												...
												<td ><a href="<?php  echo base_url();?>index.php?admin/manage_doctor/edit/<?php echo $row['doctor_id']; ?>"
						...
						<!-- end: DYNAMIC TABLE -->
							...
							<div class="row">
								<div class="col-md-6">
                                <div class="panel-body">
										<?php echo form_open('admin/manage_doctor/create/' , array('role' =>'form','id'=>'form'));?>
												<div class="form-group">
													<label class="control-label" for="exampleInputEmail1">
														<?php echo get_phrase('name');?> <span class="symbol required"></span>
													</label>
                                       ...
                                       <?php 
										...
										?> 
												...
												<div class="form-group">
													...
													<input type="text" name="profile" autocomplete="off" class="form-control underline"  placeholder="<?php echo get_phrase('profile');?>">
												</div>
                                    
                                    
                                                <div class="form-group"> 
                                                <button type="submit" class="btn btn-purple"><?php echo get_phrase('add_doctor');?></button>
                                                </div>
											<?php echo form_close();?> 
										</div>
                                </div>
