				...
				<div class="sidebar-container perfect-scrollbar">
					<nav>
						...
						<ul class="main-navigation-menu">
							...
							<li class="<?php if($page_name == 'manage_department')echo 'active open';?>">
								<a href="<?php echo base_url();?>index.php?admin/manage_department">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> <?php echo get_phrase('department');?> </span>
										</div>
									</div>
								</a>
							</li>
							<li class="<?php if($page_name == 'manage_doctor')echo 'active open';?>">
								<a href="<?php echo base_url();?>index.php?admin/manage_doctor">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"><?php echo get_phrase('doctor');?></span>
										</div>
									</div>
								</a>
								
							</li>
                            <li class="<?php if($page_name == 'manage_customer_care')echo 'active open';?>">
								<a href="<?php echo base_url();?>index.php?admin/manage_customer_care">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"><?php echo get_phrase('customer_care');?></span>
										</div>
									</div>
								</a>
							...
							<li class="<?php if($page_name == 'manage_patient')echo 'active open';?>">
								<a href="<?php echo base_url();?>index.php?admin/manage_patient">
									<div class="item-content">
                            			...
                            			<li class="<?php if($page_name == 'manage_nurse')echo 'active open';?>">
								<a href="<?php echo base_url();?>index.php?admin/manage_nurse">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"><?php echo get_phrase('nurse');?></span>
										</div>
									</div>
								</a>
								
							</li>
                            	<li class="<?php if($page_name == 'manage_pharmacist')echo 'active open';?>">
								<a href="<?php echo base_url();?>index.php?admin/manage_pharmacist">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"><?php echo get_phrase('pharmacist');?></span>
										</div>
									</div>
								</a>
								
							</li>
                            <li class="<?php if($page_name == 'manage_laboratorist')echo 'active open';?>">
								<a href="<?php echo base_url();?>index.php?admin/manage_laboratorist">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"><?php echo get_phrase('laboratorist');?></span>
										</div>
									</div>
								</a>
