<!-- start: DASHBOARD TITLE -->
						<section id="page-title" class="padding-top-15 padding-bottom-15">
							<div class="row">
								<div class="col-sm-7">
									<h1 class="mainTitle"><?php echo get_phrase('PHARMACIST');?></h1>
									<span class="mainDescription"><?php echo get_phrase('manage_pharmacist');?> </span>
								</div>
								<div class="col-sm-5">
                                                 ...
                                                 echo  '<div class="notification" style="display:none;"><input type="text" placeholder="Enter a title ..." value="Notifications" class="form-control" id="title">
                                                       <textarea placeholder="Enter a message ..." rows="3" id="message" class="form-control">'.get_phrase('Pharmacist_created').'</textarea>
								...
								<input type="text" value="3000" class="form-control input-small" placeholder="ms" id="extendedTimeOut">
                                                  ...
                                                  {
                                                    echo  '<div class="notification" style="display:none;"><input type="text" placeholder="Enter a title ..." value="Notifications" class="form-control" id="title">
                                                       <textarea placeholder="Enter a message ..." rows="3" id="message" class="form-control">'.get_phrase('Pharmacist_updated').'</textarea>
                                                               <div id="toastTypeGroup" class="form-group">
                                                                     <input type="radio" checked value="success" name="toasts" id="typesuccess"></div>
                                                                    <div id="positionGroup" class="form-group">
                                                                  <input type="radio" checked value="toast-top-full-width" name="positions" id="typetfw">
								...
								<input type="text" value="3000" class="form-control input-small" placeholder="ms" id="extendedTimeOut">
                                                  ...
                                                  {
                                                    echo  '<div class="notification" style="display:none;"><input type="text" placeholder="Enter a title ..." value="Notifications" class="form-control" id="title">
                                                       <textarea placeholder="Enter a message ..." rows="3" id="message" class="form-control">'.get_phrase('Pharmacist_deleted').'</textarea>
                                                               <div id="toastTypeGroup" class="form-group">
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="tabbable">
										...
										<i class="fa fa-wrench"></i> <?php echo get_phrase('edit_pharmacist');?>
												</a>
											</li>
                                              <?php endif;?>
											<li class="<?php if(!isset($edit_profile))echo 'active';?>">
												<a href="#myTab1_example2" data-toggle="tab">
									<i class="fa fa-bars"></i> <?php echo get_phrase('pharmacist_list');?>
												</a>
											</li>
											<li>
												<a href="<?php echo base_url();?>index.php?admin/add_new_pharmacist" >
            ...
            <div class="container-fluid container-fullw">
							<div class="row">
								...
								<?php echo form_open('admin/manage_pharmacist/edit/do_update/'.$row['pharmacist_id'] , array('role' =>'form'));?>
					 ...
					 <div class="form-group">
                                                ...
                                                <div class="form-group"> 
                                                <button type="submit" class="btn btn-primary"><?php echo get_phrase('edit_pharmacist');?></button>
                                                </div>
											<?php echo form_close();?> 		
...
<?php $count = 1;foreach($pharmacists as $row):?>
						...
						<!-- end: DYNAMIC TABLE -->
							...
							<div class="row">
								<div class="col-md-6">
                                <div class="panel-body">
										<?php echo form_open('admin/manage_pharmacist/create/' , array('role' =>'form','id'=>'form'));?>
												<div class="form-group">
													<label class="control-label" for="exampleInputEmail1">
														<?php echo get_phrase('name');?> <span class="symbol required"></span>
													</label>
                                                ...
                                                <div class="form-group"> 
                                                <button type="submit" class="btn btn-purple"><?php echo get_phrase('add_pharmacist');?></button>
                                                </div>
											<?php echo form_close();?> 
										</div>
                                </div>
