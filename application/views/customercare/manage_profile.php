<!-- start: DASHBOARD TITLE -->
						<section id="page-title" class="padding-top-15 padding-bottom-15">
							<div class="row">
								<div class="col-sm-7">
									<h1 class="mainTitle"><?php echo get_phrase('CUSTOMER CARE');?></h1>
									<span class="mainDescription"><?php echo get_phrase('add_new_customercare')?> </span>
								</div>
								<div class="col-sm-5">
			...
			<?php echo form_open('customercare/manage_profile/update_profile_info/' , array('role' =>'form','id'=>'form'));?>
												<fieldset>
														<legend>
															Account Info
														</legend>
...
<!--																<div class="form-group">
                    ...
                    foreach($edit_profile as $row):
                        ?>
                        <?php echo form_open('customercare/manage_profile/change_password' , array('class' => 'form-horizontal validatable'));?>
