		...
		<div class="tab-content">
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                         ...
                         <div class="control-group">
                            ...
                            <div class="control-group">
                               ...
                               <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('client number');?></label>
                                <div class="controls">
                    <input readonly="readonly" type="text" class="" name="clientno" value="<?=generateuniqueID(); ?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('religion');?></label>
                          ...
                          <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('name of insurance');?></label>
                                <div class="controls">
                                    <input type="text" class="validate[required]" name="noi"/>
                                </div>
                            </div>   
                               ...
                               <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('insurance number');?></label>
                                <div class="controls">
                                    <input type="text" class="validate[required]" name="insurancenumber"/>
                                </div>
                            </div>  
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('policy holder\'s name');?></label>
                                <div class="controls">
                                    <input type="text" class="validate[required]" name="phn"/>
                                </div>
                            </div> 
                             <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('policy holder\'s date of birth');?></label>
                                <div class="controls">
                                    <input type="text"  class="datepicker fill-up"  name="phdob"/>
                                </div>
                            </div>  
             ...
             <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('name of next of kin');?></label>
                                <div class="controls">
                                    <input type="text" class="validate[required]" name="nonok"/>
                                </div>
                            </div> <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('relationship');?></label>
                                <div class="controls">
                                    <input type="text" class="validate[required]" name="relationship"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('phone number');?></label>
                                <div class="controls">
                                    <input type="text" class="validate[required]" name="nokphoneno"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('Email');?></label>
                                <div class="controls">
                                    <input type="text" class="validate[required]" name="nokemail"/>
                                </div>
                            </div> <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('Home Address');?></label>
                                <div class="controls">
                                    <input type="text" class="validate[required]" name="nokhomeaddress"/>
                                </div>
                            </div>         
