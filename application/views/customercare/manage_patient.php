...
<!-- start: DASHBOARD TITLE -->
							...
							<div class="row">
								<div class="col-md-12">
									...
									<i class="fa fa-bars"></i> <?php echo get_phrase('patient_list');?>
											...
											<li>
												<a href="<?php echo base_url();?>index.php?customercare/add_new_patient">
	...
	<?php echo form_open('customercare/manage_patient/edit/do_update/'.$row['patient_id'] , array('role' =>'form','id'=>'form'));?>
                    ...
                    <?php $count = 1;foreach($patients as $row):?>
						...
						<!-- end: DYNAMIC TABLE -->
							...
							<div class="row">
								<div class="col-md-6">
                                <div class="panel-body">
										<?php echo form_open('doctor/manage_patient/create/' , array('role' =>'form','id'=>'form'));?>
                                        <h4><?php echo get_phrase('personal_information');?></h4>
                                           <div class="form-group">
													<label class="control-label" >
														<?php echo get_phrase('Title');?> <span class="symbol required"></span>
